...
if (isset($_SESSION['customer_name']) && isset($_SESSION['email'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        oci_bind_by_name($Update, ':resident_status', $resident_status);
        ...
        if (oci_execute($Update)) {
            ...
            echo "<script>alert('Address submission failed');</script>";
        }
    }
} else {
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <div class="btn-container-user" style="margin-right: 70px;">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle nav-box" type="button" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-user"></i> <?php echo $customer_name; ?>
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li>
                                        <form method="post">
                                            <button type="submit" name="logout"
                                                    class="btn btn-outline-secondary btn-lg">Logout
                                            </button>
                                        </form>
                                    </li>
                                </ul>
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <h1>Address</h1>
                ...
                <form method="post" name="form1" class="was-validated">
                    ...
                    <div class="form-outline mb-4">
                        <label class="form-label" for="resident_status">Resident Status:</label>
                        <input type="text" name="resident_status" id="resident_status" class="form-control form-control-lg"
                               value="<?php echo $resident_status; ?>" />
                    </div>
                    <div class="form-outline mb-4">
